...
class EditRegistrarProfile extends StatefulWidget {
  ...
  const EditRegistrarProfile({super.key, required this.username, required this.onSave});
...
class _EditProfileState extends State<EditRegistrarProfile> {
  ...
  final AdminUpdateController UpdateAdmin = AdminUpdateController();
    final AdminUpdateProfileController UpdateprofileAdmin = AdminUpdateProfileController();
  ...
  final fullname =  '${_firstNameController.text.isEmpty ? null : _firstNameController.text} ${_middleNameController.text.isEmpty ? null : _middleNameController.text} ${_lastNameController.text.isEmpty ? null : _lastNameController.text}';
  final firstName = _firstNameController.text.isEmpty ? null : _firstNameController.text;
  final middleName = _middleNameController.text.isEmpty ? null : _middleNameController.text;
  final lastName = _lastNameController.text.isEmpty ? null : _lastNameController.text;
  final usertype = _usertypeController.text.isEmpty ? null : _usertypeController.text;
  final address = _addressController.text.isEmpty ? null : _addressController.text;
  final number = _numberController.text.isEmpty ? null : _numberController.text;
