...
import 'package:plsp/RegistrarsAdmin/Obtainable/Controller.dart';
import 'package:plsp/RegistrarsAdmin/Obtainable/Model.dart';
import 'package:plsp/RegistrarsAdmin/Obtainable/PendingList.dart';
...
class ViewRequestPage extends StatefulWidget {
  const ViewRequestPage({
    ...
    required this.onClearSelection, required this.window, required this.admin,
...
void _updateRequestToObtained() async {
  if (_formKey.currentState!.validate()) {
    final request = DocumentRequest(
      ...
      window: widget.window, // Assuming 'window' is part of the widget's data
      adminAssigned: widget.admin, // Add adminAssigned field
    );
    ...
    if (success) {
      _showSuccessMessage(
          "Document request has been updated successfully to Obtained!");
