...
import 'package:plsp/RegistrarsAdmin/Obtainable/ViewRequestPage.dart';
...
class _PendingListState extends State<PendingList> {
  ...
  void _updateSearchQuery(String query) {
   ...
   List<PendingDocumentRequest> _paginate(List<PendingDocumentRequest> students) {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: 
      StreamBuilder<ProgramWindowModel?>(
          ...
          children: paginatedStudents.map((student) {
            ...
            _selectedStudent != null
                ? Expanded(
                  ...
                  height: height,
                  widget: widget,
                  onClearSelection: _clearSelectedStudent, window: programWindowModel.windowName, admin: widget.username,
                                    ),
                )
