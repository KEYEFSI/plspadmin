        ...
        child: StreamBuilder<DocumentStatisticsResponse>(
            ...
            builder: (context, snapshot) {
              ...
              final bool isIncreasedPending =
                  data.paidCount > data.completedCount;
              final bool isIncreasedApproved =
                  data.paidCount < data.completedCount;
              final bool isIncreasedRejected =
                  data.completedCount > data.obtainedCount;
                                        ...
                                        Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Gap(fontsize / 400),
                                                Text(
                                                  '${double.parse(data.paidPercentage.replaceAll('%', '')).toInt()}%',
                                                  style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.bold,
                                                    color: isIncreasedPending
                                                        ? Colors.green
                                        ...
                                        Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Gap(fontsize / 400),
                                                Text(
                                                  '${double.parse(data.completedPercentage.replaceAll('%', '')).toInt()}%',
                                                  style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.bold,
                                                    color: isIncreasedApproved
                                                        ? Colors.green
                                        ...
                                        Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Gap(fontsize / 400),
                                                Text(
                                                  '${double.parse(data.obtainedPercentage.replaceAll('%', '')).toInt()}%',
                                                  style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.bold,
                                                    color: isIncreasedRejected
                                                        ? Colors.green
