...
class Counter extends StatelessWidget {
  const Counter({
    ...
    required Future<AccomplishedCount> requestsCount,
    required Future<PendingCount> transactionCount,
  })  : _studentCount = studentCount,
        _requestsCount = requestsCount,
        _transactionCount = transactionCount;

  final Future<FMSRCollegeStudentCount> _studentCount;
  final Future<AccomplishedCount> _requestsCount;
  final Future<PendingCount> _transactionCount;
                  ...
                  child: Container(
                    child: Row(
                      ...
                      children: [
                        ...
                        FutureBuilder<AccomplishedCount>(
