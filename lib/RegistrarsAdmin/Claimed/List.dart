...
import 'package:plsp/RegistrarsAdmin/Claimed/View.dart';
...
class Listing extends StatefulWidget {
  ...
  const Listing({
    ...
    required List<Course> courses, required this.admin, required this.onCallback,
  }) : _courses = courses;
...
class _ListingState extends State<Listing> {
 ...
 late Future<List<CollegeDocumentRequest>> _documentsFuture;
  ...
  Future<List<CollegeDocumentRequest>> _fetchAdminProfile() async {
    try {
      final _adminController = DocumentController();
