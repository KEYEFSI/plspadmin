...
class _PendingListState extends State<PendingList> {
  late UnpaidRequestsController _controller;
  late TextEditingController _searchController;
  late FocusNode _searchFocusNode;
  int? _selectedIndex;
  String? _selectedCourse;
  UnpaidRequest? _selectedStudent;
  ...
  List<UnpaidRequest> _paginate(List<UnpaidRequest> students) {
  ...
  void initState() {
    super.initState();
    _controller = UnpaidRequestsController();
  ...
  void _showStudentDetails(UnpaidRequest student) {
    setState(() {
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                      child: StreamBuilder<List<UnpaidRequest>>(
  ...
  List<UnpaidRequest> _filterDocuments(
    List<UnpaidRequest> documents,
    String searchQuery,
    ...
    if (selectedCourse != null) {
      filteredDocuments = filteredDocuments
          .where((student) => student.usertype == selectedCourse)
          .toList();
    }
