...
class FinanceAdminNav extends StatefulWidget {
  ...
  const FinanceAdminNav({super.key, required this.username});

  @override
  State<FinanceAdminNav> createState() => _FinanceAdminNavState();
}

class _FinanceAdminNavState extends State<FinanceAdminNav> {
  int selectedIndex = 0;
  late FinanceAdminProfileController _controller;
  AdminFinanceProfile? _adminProfile;
  ...
  void initState() {
    super.initState();
    _controller = FinanceAdminProfileController();
    _fetchAdminProfile();
  }
...
class Profile extends StatelessWidget {
  const Profile({
    ...
    required AdminFinanceProfile? adminProfile,
    required this.fontsize,
  })  : _isLoading = isLoading,
        _adminProfile = adminProfile;

  final bool _isLoading;
  final AdminFinanceProfile? _adminProfile;
