...
import 'package:plsp/FinanceAdmin/College/Counter.dart';
import 'package:plsp/FinanceAdmin/College/ViewProfile.dart';
...
class _CollegePageState extends State<CollegePage> {
  late FMSRCollegeRequestCountController _controller;
  ...
  late GetCollege _getCollege;
  CollegeRequest? _selectedStudent;
  int? _selectedIndex;
  ...
  void initState() {
    super.initState();
    _controller = FMSRCollegeRequestCountController(apiUrl: '$kUrl');
  ...
  void _fetchStudents() async {
    try {
      final fetchedStudents = await _getCollege.fetchStudentRequests();
  ...
  void _showStudentDetails(CollegeRequest student) {
    setState(() {
