...
class Finance_Admin extends StatefulWidget {
  final Future<List<FinanceAdmin>> Finance;
  ...
  @override
  State<Finance_Admin> createState() => _Finance_AdminState();
}

class _Finance_AdminState extends State<Finance_Admin> {
  late TextEditingController _searchController;
  late FocusNode _searchFocusNode;
  List<FinanceAdmin> _filteredAdmins = [];

  int? _selectedIndex;
  late Future<List<FinanceAdmin>> _finance;
  ...
  @override
  void didUpdateWidget(Finance_Admin oldWidget) {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Lottie.asset('assets/Finance.json',
              ...
              Expanded(
                child: FutureBuilder<List<FinanceAdmin>>(
                  future: _finance,
