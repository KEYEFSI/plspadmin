...
class FMSRISStudentCount {
  ...
  FMSRISStudentCount({required this.count});

  factory FMSRISStudentCount.fromJson(Map<String, dynamic> json) {
    return FMSRISStudentCount(
      count: json['count'],
    );
  }
}

class FMSRISRequestsCount {
  ...
  factory FMSRISRequestsCount.fromJson(Map<String, dynamic> json) {
    try {
...
class FMSRISStudentTransactionCount {
  ...
  factory FMSRISStudentTransactionCount.fromJson(Map<String, dynamic> json) {
    return FMSRISStudentTransactionCount(
...
class Is {
  ...
  // Factory constructor to create a Student from JSON
  factory Is.fromJson(Map<String, dynamic> json) {
    return Is(
      username: json['username'] as String?,
      fullname: json['fullname'] as String?,
      number: json['number'] as String?,
