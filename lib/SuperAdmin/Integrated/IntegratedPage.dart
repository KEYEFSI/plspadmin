...
import 'package:plsp/SuperAdmin/Integrated/Counter.dart';
...
import 'package:plsp/SuperAdmin/Integrated/ViewProfile.dart';
...
class IntegratedPage extends StatefulWidget {
  ...
  @override
  State<IntegratedPage> createState() => _IntegratedPageState();
}

class _IntegratedPageState extends State<IntegratedPage> {
  late FMSRISRequestCountController _controller;
  late Future<FMSRISRequestsCount> _requestsCount;
  late FMSRISStudentCountController _controllers;
  late Future<FMSRISStudentCount> _studentCount;
  late FMSRISTransactionCountController _controllert;
  late Future<FMSRISStudentTransactionCount> _transactionCount;

  late TextEditingController _searchController;
  late FocusNode _SearchFocusNode;
  late GetIS getCollege;
  late FocusNode _searchFocusNode;
  int? _selectedIndex;
  ...
  void initState() {
    super.initState();
    _controller = FMSRISRequestCountController(apiUrl: '$kUrl');
    _requestsCount = _controller.fetchRequestsCount();
    _controllers = FMSRISStudentCountController(apiUrl: '$kUrl');
    _studentCount = _controllers.fetchStudentCount();
    _controllert = FMSRISTransactionCountController(apiUrl: '$kUrl');
  ...
  Future<void> _exportToExcel() async {
    if (studentsList.isNotEmpty) {
      ...
      Sheet sheetObject = excel['Integrated_Students'];
      ...
      final fileName = 'Integrated_Students.xlsx';
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text('Export successful! File saved at: $filePath')),
        );
      } catch (e) {
      ...
      body: SafeArea(
        child: Padding(
          padding: EdgeInsetsDirectional.fromSTEB(
              fontsize / 80, height / 84, fontsize / 80, height / 42),
          child: Row(
            children: [
              Expanded(
                flex: 3,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        gradient:
                                                                          ...
                                                                          begin:
                                                                              Alignment.centerLeft, // Start at the top
                                                                          end: Alignment
                                                                              .centerRight,
                                                                        ),
                                                                        borderRadius:
