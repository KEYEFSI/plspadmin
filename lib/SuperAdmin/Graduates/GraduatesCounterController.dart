...
class GetGraduates extends ChangeNotifier {
  // Static API URL since we removed baseUrl
  final String apiUrl = "$kUrl/FMSR_AdminShowGraduates"; // Assuming `kUrl` is a predefined constant

  // StreamController to manage the stream of data
