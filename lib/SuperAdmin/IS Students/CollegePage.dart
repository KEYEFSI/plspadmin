...
import 'ApprovedAccts/ApprovedAcct.dart';
import 'PendingAccts/PendingAccounts.dart';

class ISPending extends StatefulWidget {
  ...
  @override
  State<ISPending> createState() => _ISPendingState();
}

class _ISPendingState extends State<ISPending> {
  @override
  void initState() {
    super.initState();
  }
