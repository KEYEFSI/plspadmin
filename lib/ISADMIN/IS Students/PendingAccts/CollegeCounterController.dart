...
class RejectStudentController {
  final String apiUrl = "$kUrl/FMSR_RejectISStudent";

  Future<RejectStudentResponse> rejectStudent(RejectStudentRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        return RejectStudentResponse.fromJson(jsonDecode(response.body));
      } else {
