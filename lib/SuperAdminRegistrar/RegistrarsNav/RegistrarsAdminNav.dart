...
import 'package:plsp/SuperAdminRegistrar/Admin/EditProfile.dart';
import 'package:plsp/SuperAdminRegistrar/AdminAccounts/AdminAccounts.dart';
import 'package:plsp/SuperAdminRegistrar/Dashboard/DashboardPage.dart';
import 'package:plsp/SuperAdminRegistrar/WindowandPrograms/View.dart';
import 'package:plsp/SuperAdminRegistrar/RegistrarsNav/ProfileController.dart';
import 'package:plsp/SuperAdminRegistrar/RegistrarsNav/ProfileModel.dart';
...
class RegistrarsSuperAdminNav extends StatefulWidget {
  ...
  const RegistrarsSuperAdminNav({super.key, required this.username});

  @override
  State<RegistrarsSuperAdminNav> createState() =>
      _RegistrarsSuperAdminNavState();
}

class _RegistrarsSuperAdminNavState extends State<RegistrarsSuperAdminNav> {
  int selectedIndex = 0;
  late AdminProfileController _controller;
  AdminRegistrarProfiles? _adminProfile;
  ...
  final List<NavigationItem> navigationItems = [
    ...
    NavigationItem(
      ...
      tooltip: 'Windows And Programs',
      lottieFile: 'assets/Design.json',
    ),
    NavigationItem(
      icon: FontAwesome5Solid.user_graduate,
      tooltip: 'Student Accounts',
...
class Profile extends StatelessWidget {
  const Profile({
    ...
    required AdminRegistrarProfiles? adminProfile,
    required this.fontsize,
  })  : _isLoading = isLoading,
        _adminProfile = adminProfile;

  final bool _isLoading;
  final AdminRegistrarProfiles? _adminProfile;
