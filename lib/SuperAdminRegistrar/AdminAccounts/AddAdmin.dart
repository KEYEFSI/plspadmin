...
class _AddAdminPageState extends State<AddAdminPage> {
  ...
  List<WindowData> _windowsData = [];
  String? _selectedWindow;

  @override
  void initState() {
    super.initState();
    _controller.startAutoRefresh(); // Start auto-refresh on initialization
  }
  ...
  final CreateAdminController _createAdminController = CreateAdminController();
  ...
  void _createAdmin() async {
    ...
    final admin = CreateAdminModel(
      ...
      email: email,
      window: int.tryParse(_selectedWindow ?? '') ?? 0,
    );

    final result = await _createAdminController.createAdmin(admin);
