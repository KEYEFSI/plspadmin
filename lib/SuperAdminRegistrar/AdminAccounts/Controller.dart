...
class AdminController {
  final String apiUrl = "$kUrl/FMSR_Admins";
...
class CreateAdminController {
  final String apiUrl = "$kUrl/FMSR_Admins_Save"; // Replace with your actual API URL

  // Method to create a new admin
  Future<Map<String, dynamic>> createAdmin(CreateAdminModel admin) async {
    try {
      final response = await http.post(
        Uri.parse(apiUrl),
        headers: kHeader,
