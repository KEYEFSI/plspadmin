...
class PendingGraduates extends StatefulWidget {
  const PendingGraduates({
    super.key,
  });

  @override
  State<PendingGraduates> createState() => _PendingGraduatesState();
}

class _PendingGraduatesState extends State<PendingGraduates> {
 
  final DeleteStudentController controller = DeleteStudentController();
  late GraduatesStudentController _controller = GraduatesStudentController();
  ...
  List<GraduatesStudent> _paginate(List<GraduatesStudent> students) {
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<GraduatesStudent>>(
