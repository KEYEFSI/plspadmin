...
import 'CollegeCounterController.dart';
import 'CollegeCounterModel.dart';

class CollegeOrdinary extends StatefulWidget {
  const CollegeOrdinary({
    super.key,
  });

  @override
  State<CollegeOrdinary> createState() => _CollegeOrdinaryState();
}

class _CollegeOrdinaryState extends State<CollegeOrdinary> {
  final OrdinaryStudentController _controller = OrdinaryStudentController();
  ...
  List<OrdinaryStudent> _paginate(List<OrdinaryStudent> students) {
  ...
  void _showConfirmation(username) {
              ...
              color: Colors.green.shade900,
                        ...
                        Column(
                          children: paginatedStudents.map((student) {
                            ...
                            return Container(
                              decoration: BoxDecoration(
                                color:  isHover? Colors.red.shade100 : isHovered
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      ...
                                      horizontal: fontsize/160, vertical: height/180 ),
                                              decoration: BoxDecoration(
                                                color: Colors.green.shade900,
                                                borderRadius:
                                      ...
                                      MouseRegion(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            _showReasonDialog(student.username!);
                                            print(
  ...
  void _approveStudent(String username) async {
    ...
    void _rejectStudent(BuildContext context, String username, String  reason) async {
