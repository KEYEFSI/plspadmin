...
class TCPAccounts extends StatefulWidget {
  const TCPAccounts({
    super.key,
  });

  @override
  State<TCPAccounts> createState() => _TCPAccountsState();
}

class _TCPAccountsState extends State<TCPAccounts> {

 
   late TCPStudentController _controller = TCPStudentController();
  ...
  List<TCPStudent> _paginate(List<TCPStudent> students) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: StreamBuilder<List<TCPStudent>>(
