...
class DeleteStudentController {
  final String apiUrl = "$kUrl/FMSR_DeleteStudent";

  Future<DeleteStudentResponse> deleteStudent(DeleteStudentRequest request) async {
    try {
      ...
      if (response.statusCode == 200) {
        return DeleteStudentResponse.fromJson(jsonDecode(response.body));
      } else {
