...
class AlumniAcct extends StatefulWidget {
  const AlumniAcct({
    super.key,
  });

  @override
  State<AlumniAcct> createState() => _AlumniAcctState();
}

class _AlumniAcctState extends State<AlumniAcct> {

 
  late AlumniStudentController _controller = AlumniStudentController();
  ...
  List<AlumniStudent> _paginate(List<AlumniStudent> students) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Expanded(
              child: StreamBuilder<List<AlumniStudent>>(
